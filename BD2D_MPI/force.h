...
public:
  ...
  template<typename TPar1, typename TPar2, typename BiFunc>
  void eval(TPar1 &p1, TPar2 &p2, BiFunc untangle) const;
private:
...
template<typename TPar1, typename TPar2, typename BiFunc>
void SpringForce::eval(TPar1 & p1, TPar2 & p2, BiFunc untangle) const {
